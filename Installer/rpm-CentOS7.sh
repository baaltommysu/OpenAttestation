...
RPMbuild()
{
  if test -e ./OAT-Appraiser-Base-CentOS7.spec;then
    cp OAT-Appraiser-Base-CentOS7.spec $RPM_BUILD_SPECS_DIRECTORY
  else
    ShowLogFaild "./OAT-Appraiser-Base-CentOS7.spec"
  fi
  ...
  rpmbuild -bb OAT-Appraiser-Base-CentOS7.spec
}
